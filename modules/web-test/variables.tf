...
variable "configuration" {
  description = "An XML configuration specification for this Web Test. Only supported for Classic Web Test."
  type        = string
  default     = null
}
...
variable "request" {
  description = "The request generated by this Web Test. Only supported for Standard Web Test."
...
variable "validation_rules" {
  description = "The validation rules for this Web Test. Only supported for Standard Web Test."
